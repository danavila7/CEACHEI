                 ...
                 <th>
                    <a href="{{ URL::to('/') }}/ListaUsuarios?ord=activo">
                        <span class="glyphicon glyphicon-arrow-up"></span>
                                                    ...
                                                    <a href="{{ URL::to('/') }}/ListaIntructores?ord=-activo">
                        <span class="glyphicon glyphicon-arrow-down"></span>
                    </a>
                                             Activo            </th>
                 <th>
                                                <a href="{{ URL::to('/') }}/ListaIntructores?ord=nombre">
                        <span class="glyphicon glyphicon-arrow-up"></span>
                    </a>
                                                    <a href="{{ URL::to('/') }}/ListaIntructores?ord=-nombre">
                        <span class="glyphicon glyphicon-arrow-down"></span>
                                             ...
                                             Nombre            </th>
                 <th>
                                                <a href="{{ URL::to('/') }}/ListaIntructores?ord=apellido_paterno">
                        <span class="glyphicon glyphicon-arrow-up"></span>
                    </a>
                                                    <span class="glyphicon glyphicon-arrow-down"></span>
                                             Apellido Paterno            </th>
                 <th>
                                                <a href="{{ URL::to('/') }}/ListaIntructores?ord=apellido_materno">
                        <span class="glyphicon glyphicon-arrow-up"></span>
                    </a>
                                                    <a href="{{ URL::to('/') }}/ListaIntructores?ord=-apellido_materno">
                        <span class="glyphicon glyphicon-arrow-down"></span>
